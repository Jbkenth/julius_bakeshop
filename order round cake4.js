function multiply4(){
	a = Number(document.getElementById('QTY4').value);
	b = Number(document.getElementById('PRICE4').value);
...
function uncheck4(){
	...
	input.checked = false;
	get.disabled = true;
	a = Number(document.getElementById('PRICE4').value);
	b = Number(document.getElementById('QTY4').value);
	...
	a = 0;
	e = a * b + a2 * b2 + a3 * b3 + a4 * b4 + a5 * b5 + a6 * b6;
	document.getElementById('TOTAL4').value = a;
	document.getElementById('QTY4').value = a;
	document.getElementById('TOTAL ALL').value = e;
}
document.getElementById('img4').onchange = function() {
	document.getElementById('QTY4').disabled = !this.checked;
	a = 1;
	document.getElementById('QTY4').value = a;
}