function multiply5(){
	a = Number(document.getElementById('QTY5').value);
	b = Number(document.getElementById('PRICE5').value);
	...
	a4 = Number(document.getElementById('QTY2').value);
	b4 = Number(document.getElementById('PRICE2').value);
	a5 = Number(document.getElementById('QTY4').value);
	b5 = Number(document.getElementById('PRICE4').value);
...
function pic5(){
	...
	let get = document.getElementById('QTY5');
	input.checked = true;
	get.disabled = false;
	...
	b4 = Number(document.getElementById('TOTAL3').value);
	b5 = Number(document.getElementById('TOTAL4').value);
...
function uncheck5(){
	...
	input.checked = false;
	get.disabled = true;
	a = Number(document.getElementById('PRICE5').value);
	b = Number(document.getElementById('QTY5').value);
	a4 = Number(document.getElementById('PRICE3').value);
	b4 = Number(document.getElementById('QTY3').value);
	...
	a5 = Number(document.getElementById('PRICE4').value);
	b5 = Number(document.getElementById('QTY4').value);
	...
	document.getElementById('QTY5').value = a;
	document.getElementById('TOTAL ALL').value = e;
}
document.getElementById('img5').onchange = function() {
	document.getElementById('QTY5').disabled = !this.checked;
	a = 1;
	document.getElementById('QTY5').value = a;
}