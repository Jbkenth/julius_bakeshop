function multiply6(){
	a = Number(document.getElementById('QTY6').value);
	b = Number(document.getElementById('PRICE6').value);
    ...
    a6 = Number(document.getElementById('QTY').value);
	b6 = Number(document.getElementById('PRICE').value);
	d = a * b;
	e = (a * b) + (a2 * b2) + (a3 * b3) + (a4 * b4) + (a5 * b5) + (a6 * b6);
	document.getElementById('TOTAL6').value=d;
	document.getElementById('TOTAL ALL').value=e;
}
function pic6(){
	let input = document.getElementById('img6');
	let get = document.getElementById('QTY6');
	input.checked = true;
	get.disabled = false;
	a = Number(document.getElementById('img6').value);
	b = Number(document.getElementById('PRICE6').value);
    ...
    b6 = Number(document.getElementById('TOTAL').value);
	d = a * b;
...
function uncheck6(){
	...
	input.checked = false;
	get.disabled = true;
	a = Number(document.getElementById('PRICE6').value);
	b = Number(document.getElementById('QTY6').value);
	...
	a5 = Number(document.getElementById('QTY5').value);
	b5 = Number(document.getElementById('PRICE5').value);
    a6 = Number(document.getElementById('PRICE').value);
	b6 = Number(document.getElementById('QTY').value);
	a = 0;
	e = a * b + a2 * b2 + a3 * b3 + a4 * b4 + a5 * b5 + a6 * b6;
	document.getElementById('TOTAL6').value = a;
	document.getElementById('QTY6').value = a;
	document.getElementById('TOTAL ALL').value = e;
}
document.getElementById('img6').onchange = function() {
	document.getElementById('QTY6').disabled = !this.checked;
	a = 1;
	document.getElementById('QTY6').value = a;
}